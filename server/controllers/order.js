...
const createNewOrder = asyncHandler(async (req, res) => {
    ...
    const userCart = await User.findById(_id).select('cart').populate('cart.product', 'title price') //populate chỉ lấy cho thằng nào có type:mongose.Types.ObjectId ở đây là product trong cart.
