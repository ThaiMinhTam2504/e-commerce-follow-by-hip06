            ...
            <div className='h-[103px] bg-main w-full flex items-center justify-center'>
                <div className='w-main flex items-center justify-between '>
                    ...
                    <div className='flex-1 flex items-center'>
                        <input
                            className='p-4 pr-0 rounded-l-full  w-full bg-[#F04646] outline-none text-gray-100 placeholder:text-sm placeholder:text-gray-100
            ...
            <div className='h-[407px] w-full bg-gray-900 flex items-center justify-center text-white text-[13px]' >
                <div className='w-main flex '>
                    <div className='flex-2 flex flex-col gap-2'>
                        ...
                        <span>
                            <span>Phone: </span>
                            <span className='opacity-70'>(+1234) 56789xx</span>
                        </span>
                        <span>
                            <span>Email: </span>
                            <span className='opacity-70'>email@gmail.com</span>
                        </span>
                    </div>
